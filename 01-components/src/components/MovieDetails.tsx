import { useGetDetailsQuery } from 'app/apiSlice';
import React from 'react';
import { useNavigate, useParams } from 'react-router-dom';
import { Genres, Videos } from 'utils/TMDBinterfaces';
import { Preloader } from './Network';
...
export default function MovieDetailed() {
  ...
  const { searchModel: model, movieId } = useParams();
